...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT id, firstname, lastname, email, username, passkey, designation_id FROM users WHERE email = ?";
        ...
        if($stmt = mysqli_prepare($connection, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $firstname, $lastname, $email, $username, $hashed_password, $usertype) ;
