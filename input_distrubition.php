...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">DISTRUBITION</h1>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                $findcluster = selectAll('input_distrubution');
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo preg_replace('/[^0-9]/', '', $cluster['Total_amount_of_Input_allocatedReceived_KG_bags']); ?></td>
                                        <td><?php echo preg_replace('/[^0-9]/', '', $cluster['Total_Number_of_Fertilizer_Received_Kg_Bags']); ?></td>
